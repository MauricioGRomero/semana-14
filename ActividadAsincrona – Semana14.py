...
#en esta parte ponemos el else para que cuando el usuario quiera preguntar por otro depaartamento lo devuelva para esta parte pero eso es para más adelante en el código
        else:
            print("===================================================================================")
#preguntamos de qué departamento quiere saber  sus municipios
...
#y los imprimimos como una lista usando For. así con los demás departamentos
                    ...
                    continue
#luego le preguntamos al usuario si desea volver a usar el programa y si dice que sí lo devlvera desde el else antes mencionado
